...
//并使用默认的文档解析器TextDocumentParser对文档进行解析
        Document document = FileSystemDocumentLoader.loadDocument("/Users/agq/JAVA/java-ai-langchain4j/src/main/resources/测试.txt");
    ...
    public void testParsePDF() {
        Document document = FileSystemDocumentLoader.loadDocument(
                "/Users/agq/Downloads/knowledge/医院信息.pdf",
    ...
    public void testReadDocumentAndStore() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("/Users/agq/Downloads/knowledge/人工智能.md");
...
//DocumentByParagraphSplitter documentSplitter = newDocumentByParagraphSplitter(300, 30);
    ...
    //计算 token 长度
        QwenTokenizer tokenizer = new QwenTokenizer("sk-15cac3e359e348f2bd07e379820c9e30", "qwen-max");
